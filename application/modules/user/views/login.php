...
<head>
    ...
    <link rel="icon" type="<?php echo base_url();?>asset/image/png" href="assets/img/favicon-16x16.png" sizes="16x16">
...
<body class="login_page">
   ...
   <img src="<?php echo base_url();?>asset/images/user.png" width="90px" height="80px"/></div>
                </div>
                <form method="post" action="<?php echo base_url();?>logistic/Forwarder/cek_login">
                    <div class="uk-form-row">
                        <label for="login_username">Username</label>
                        <input class="md-input" type="text" id="login_username" name="us" />
                    </div>
                    <div class="uk-form-row">
                        <label for="login_password">Password</label>
                        <input class="md-input" type="password" id="login_password" name="ps" />
                    </div>
 
<p style="color:red"><?php echo isset($message)?$message:'' ;?></p>
                    <div class="uk-margin-medium-top">
                        <input name="" type="submit" value="Login" class="md-btn md-btn-primary md-btn-block md-btn-large">
                    </div>
