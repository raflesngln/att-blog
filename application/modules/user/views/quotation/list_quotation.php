...
<div class="md-card-content">
 ...
 <li onclick="changeTabs('process');" aria-expanded="false" class=""><a href="#"><i class="md-list-addon-icon material-icons md-24">refresh</i> Pending<sup class="uk-badge uk-badge-danger uk-badge-circle">2</sup></a></li>
  ...
  <?php $this->load->view('logistic/quotation/list/all');?>
                                </li>
                                
      <li aria-hidden="true" class="" id="open">
    <?php $this->load->view('logistic/quotation/list/open');?>                          
      </li>
    <li aria-hidden="true" class="" id="process">
    <?php $this->load->view('logistic/quotation/list/process');?>                            
    </li>
 <li aria-hidden="true" class="" id="canceled">
 <?php $this->load->view('logistic/quotation/list/cancel');?>                               
 </li>
