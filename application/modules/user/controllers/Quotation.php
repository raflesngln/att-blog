...
class Quotation extends CI_Controller{
    ...
    function index(){
		  ...
		  'view'=>'logistic/quotation/list_quotation'
		  );
 ...
 function quotation_detail(){
	 $idcust=$this->uri->segment(4);
		  ...
		  'sidemenu'=>'<a href="'.base_url().'">customer_detail</a>',
		  'record'=>$this->Model_inquiry->getDataCustom("*","trcust_hdr"," WHERE Id='$idcust'"),
		  'view'=>'quotation/detail_quotation'
		  );
	      $this->load->view('template/home',$data);
	 
}

 function manage_quotation(){
	 $idcust=$this->uri->segment(4);
       	  $data=array(
		  'title'=>'Inquery Details ',
		  'modulname'=>'CRM for Forwarder',
 ...
 function list_quotation()
	{
		...
		foreach ($list as $datalist){
			...
			'Volume' =>'<div align="right">'.$datalist->Volume.'</div>',
			'Status' =>$datalist->Volume <= 25 ?'<span class="uk-badge uk-badge-primary">Open</span>':'<span class="uk-badge uk-badge-success">Approved</span>',
			...
			'action' =>'<div class="uk-button-dropdown" data-uk-dropdown>
                                ...
                                <div class="uk-dropdown uk-dropdown-small">
                                    <ul class="uk-nav uk-nav-dropdown">
                                        <li onclick="load_quotation()"><a href="#" ><i class="material-icons">description</i>App Quotation</a></li>
