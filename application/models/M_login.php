...
$query=$this->db->query("select*from pelanggan where username='$username' and password='$password'");
...
//=================== CHECK PELANGGAN===============================
	function profil_user($kode)
	{
		$query=$this->db->query("select * from pelanggan where id_pelanggan='$kode'");
		return $query->result();
	}
//=================== UPDATE PELANGGAN===============================
...
//=====================login member cek============================
    public function data_pelanggan($idpel)
    {
        $q = $this->db->query("select*from pelanggan where id_pelanggan='$idpel'");
