...
//-- for List admin--///////////////////////////////////////////
private function _get_query_list_admin($nm_coloum,$orderby,$where)
	{	
		$i = 0;
...
function get_list_admin($selected,$nm_tabel,$nm_coloum,$orderby,$where)
	{
		
		$this->db->select($selected);
	    $this->db->from($nm_tabel);
		$this->_get_query_list_admin($nm_coloum,$orderby,$where);
...
public function count_all_list_admin($nm_tabel,$nm_coloum)
	{
		$this->db->from($nm_tabel);
		return $this->db->count_all_results();
}

public function count_filtered_list_admin($nm_tabel,$nm_coloum,$orderby,$where)
	{
		$this->_get_query_list_admin($nm_coloum,$orderby,$where);
        $this->db->from($nm_tabel);
		return $this->db->count_all_results();
