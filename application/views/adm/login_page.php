...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="<?php echo base_url();?>assets/assets_admin/monster/image/png" sizes="16x16" href="<?php echo base_url();?>assets/assets_admin/monster/images/favicon.png">
...
<body>
    ...
    <!-- ============================================================== -->
    <section id="wrapper">
        <div class="login-register" style="background-image: url('<?php echo base_url();?>assets/img/logistics/marine.jpg')">        
