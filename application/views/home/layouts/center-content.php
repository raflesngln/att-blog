        ...
        <div class="trending-post-slides owl-carousel">
                    <!-- Single Trending Post -->
                        ...
                        foreach($trending as $trend){
                            $img=$trend->post_picture;
                                ...
                                $count_title=str_word_count($trend->post_title);
                                $pieces = explode(" ", $trend->post_title);
                                if($count_title > 10){
                                    $shot_title = implode(" ", array_splice($pieces, 0, 10)).'...';
                                } else{
                                    $shot_title = implode(" ", array_splice($pieces, 0, 10));
                                }
                        ?>
                    <div class="single-trending-post">
                        ...
                        <div class="post-content">
                            <a href="<?php echo base_url();?>home/post_detail/<?php echo $trend->post_id;?>" class="post-title slide-news-text"><?php echo $shot_title;?>
                            </a>
                        </div>
                    </div>
                        <?php } ?>
                        ...
                        ?>
                            <div class="col-6 col-md-6 col-lg-4">
                                <div class="single-blog-post style-4 mb-30">
                                    <a href="<?php echo base_url();?>home/post_detail/<?php echo $recomend->post_id;?>">
                                      <figure>
